    ...
    public class MTourContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            _ = modelBuilder.Entity<Tour>().HasData(
                new Tour { Id = 1, Name = "Tour Đà Nẵng - Bà Nà Hills", Duration = 3, StartDate = new DateTime(2023, 3, 10), EndDate = new DateTime(2023, 3, 13), Type = "Cao cấp", Cost = 5000000, Pics = "danang.jpg", TransportationMethod = "Máy bay" },
                new Tour { Id = 2, Name = "Tour Phú Quốc - Biển xanh", Duration = 4, StartDate = new DateTime(2023, 4, 5), EndDate = new DateTime(2023, 4, 9), Type = "Tiêu chuẩn", Cost = 7000000, Pics = "phuquoc.jpg", TransportationMethod = "Máy bay" },
                new Tour { Id = 3, Name = "Tour Hà Nội - Hạ Long", Duration = 2, StartDate = new DateTime(2023, 5, 1), EndDate = new DateTime(2023, 5, 3), Type = "Tiết kiệm", Cost = 3000000, Pics = "halong.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 4, Name = "Tour Sapa - Fansipan", Duration = 3, StartDate = new DateTime(2023, 6, 15), EndDate = new DateTime(2023, 6, 18), Type = "Cao cấp", Cost = 6500000, Pics = "sapa.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 5, Name = "Tour Hội An - Mỹ Sơn", Duration = 2, StartDate = new DateTime(2023, 7, 10), EndDate = new DateTime(2023, 7, 12), Type = "Tiêu chuẩn", Cost = 4000000, Pics = "hoian.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 6, Name = "Tour Nha Trang - Vinpearl", Duration = 3, StartDate = new DateTime(2023, 8, 5), EndDate = new DateTime(2023, 8, 8), Type = "Cao cấp", Cost = 7500000, Pics = "nhatrang.jpg", TransportationMethod = "Máy bay" },
                new Tour { Id = 7, Name = "Tour Cần Thơ - Chợ nổi Cái Răng", Duration = 2, StartDate = new DateTime(2023, 9, 20), EndDate = new DateTime(2023, 9, 22), Type = "Tiết kiệm", Cost = 3500000, Pics = "cantho.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 8, Name = "Tour Huế - Đại Nội", Duration = 2, StartDate = new DateTime(2023, 10, 12), EndDate = new DateTime(2023, 10, 14), Type = "Tiêu chuẩn", Cost = 4200000, Pics = "hue.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 9, Name = "Tour Bến Tre - Sông nước miền Tây", Duration = 3, StartDate = new DateTime(2023, 11, 3), EndDate = new DateTime(2023, 11, 6), Type = "Tiết kiệm", Cost = 2800000, Pics = "bentre.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 10, Name = "Tour Cà Mau - Mũi Cà Mau", Duration = 3, StartDate = new DateTime(2023, 12, 25), EndDate = new DateTime(2023, 12, 28), Type = "Cao cấp", Cost = 8000000, Pics = "camau.jpg", TransportationMethod = "Máy bay" },
                new Tour { Id = 11, Name = "Tour Tây Nguyên - Buôn Ma Thuột", Duration = 1, StartDate = new DateTime(2024, 1, 15), EndDate = new DateTime(2024, 1, 19), Type = "Cao cấp", Cost = 6000000, Pics = "taynguyen.jpg", TransportationMethod = "Máy bay" },
                new Tour { Id = 12, Name = "Tour Mộc Châu - Cao nguyên xanh", Duration = 2, StartDate = new DateTime(2024, 2, 20), EndDate = new DateTime(2024, 2, 23), Type = "Tiêu chuẩn", Cost = 4500000, Pics = "mocchau.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 13, Name = "Tour Vũng Tàu - Biển đẹp", Duration = 2, StartDate = new DateTime(2024, 2, 5), EndDate = new DateTime(2024, 2, 7), Type = "Tiết kiệm", Cost = 3200000, Pics = "vungtau.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 14, Name = "Tour Hà Giang - Cao nguyên đá", Duration = 5, StartDate = new DateTime(2024, 5, 12), EndDate = new DateTime(2024, 5, 17), Type = "Cao cấp", Cost = 7000000, Pics = "hagiang.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 15, Name = "Tour Bình Thuận - Mũi Né", Duration = 5, StartDate = new DateTime(2024, 5, 8), EndDate = new DateTime(2024, 5, 11), Type = "Tiêu chuẩn", Cost = 4800000, Pics = "muine.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 16, Name = "Tour Quảng Bình - Phong Nha Kẻ Bàng", Duration = 6, StartDate = new DateTime(2024, 6, 18), EndDate = new DateTime(2024, 6, 22), Type = "Cao cấp", Cost = 7500000, Pics = "quangbinh.jpg", TransportationMethod = "Máy bay" },
                new Tour { Id = 17, Name = "Tour Lý Sơn - Đảo thiên đường", Duration = 3, StartDate = new DateTime(2024, 7, 25), EndDate = new DateTime(2024, 7, 28), Type = "Tiết kiệm", Cost = 4000000, Pics = "lyson.jpg", TransportationMethod = "Tàu thủy" },
                new Tour { Id = 18, Name = "Tour Đồng Tháp - Làng hoa Sa Đéc", Duration = 2, StartDate = new DateTime(2024, 8, 14), EndDate = new DateTime(2024, 8, 16), Type = "Tiêu chuẩn", Cost = 3500000, Pics = "sa-dec.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 19, Name = "Tour Ninh Bình - Tràng An", Duration = 2, StartDate = new DateTime(2024, 9, 10), EndDate = new DateTime(2024, 9, 12), Type = "Cao cấp", Cost = 5200000, Pics = "ninhbinh.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 20, Name = "Tour Côn Đảo - Di tích lịch sử", Duration = 3, StartDate = new DateTime(2024, 10, 22), EndDate = new DateTime(2024, 10, 25), Type = "Cao cấp", Cost = 8500000, Pics = "condao.jpg", TransportationMethod = "Máy bay" },
                new Tour { Id = 21, Name = "Tour Sapa - Núi Fansipan", Duration = 4, StartDate = new DateTime(2024, 11, 5), EndDate = new DateTime(2024, 11, 9), Type = "Cao cấp", Cost = 6500000, Pics = "sapa.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 22, Name = "Tour Huế - Cố đô", Duration = 3, StartDate = new DateTime(2024, 12, 15), EndDate = new DateTime(2024, 12, 18), Type = "Tiêu chuẩn", Cost = 5000000, Pics = "hue.jpg", TransportationMethod = "Máy bay" },
                new Tour { Id = 23, Name = "Tour Cà Mau - Mũi Cà Mau", Duration = 5, StartDate = new DateTime(2025, 1, 20), EndDate = new DateTime(2025, 1, 25), Type = "Cao cấp", Cost = 7000000, Pics = "camau.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 24, Name = "Tour Đà Lạt - Thành phố ngàn hoa", Duration = 3, StartDate = new DateTime(2025, 2, 12), EndDate = new DateTime(2025, 2, 15), Type = "Tiết kiệm", Cost = 4000000, Pics = "dalat.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 25, Name = "Tour Nha Trang - Đảo Bình Ba", Duration = 4, StartDate = new DateTime(2025, 3, 5), EndDate = new DateTime(2025, 3, 9), Type = "Cao cấp", Cost = 7500000, Pics = "nhatrang.jpg", TransportationMethod = "Máy bay" },
                new Tour { Id = 26, Name = "Tour Hà Tiên - Biển đảo", Duration = 3, StartDate = new DateTime(2023, 7, 18), EndDate = new DateTime(2023, 7, 21), Type = "Tiêu chuẩn", Cost = 4800000, Pics = "hatien.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 27, Name = "Tour Tây Ninh - Núi Bà Đen", Duration = 2, StartDate = new DateTime(2023, 6, 10), EndDate = new DateTime(2023, 6, 12), Type = "Tiết kiệm", Cost = 3000000, Pics = "tayninh.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 28, Name = "Tour Quy Nhơn - Eo Gió", Duration = 4, StartDate = new DateTime(2023, 5, 25), EndDate = new DateTime(2023, 5, 29), Type = "Cao cấp", Cost = 6800000, Pics = "quynhon.jpg", TransportationMethod = "Máy bay" },
                new Tour { Id = 29, Name = "Tour Cần Thơ - Chợ nổi Cái Răng", Duration = 2, StartDate = new DateTime(2023, 4, 8), EndDate = new DateTime(2023, 4, 10), Type = "Tiết kiệm", Cost = 3500000, Pics = "cantho.jpg", TransportationMethod = "Xe khách" },
                new Tour { Id = 30, Name = "Tour Bắc Kạn - Hồ Ba Bể", Duration = 3, StartDate = new DateTime(2023, 3, 3), EndDate = new DateTime(2023, 3, 6), Type = "Tiêu chuẩn", Cost = 4200000, Pics = "babebe.jpg", TransportationMethod = "Xe khách" }
            );
